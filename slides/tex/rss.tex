...
\begin{frame}{Average Mutual Information (AMI)}
    \begin{figure}
        \centering
        \includegraphicscopyright[width=0.7\linewidth]{rss/ami}{Work in progress (Xochicale et al. 2018)}
...
\begin{frame}{False Nearest Neighbours (FNN)}
    \begin{figure}
        \centering
        \includegraphicscopyright[width=1.0\linewidth]{rss/fnn}{Work in progress (Xochicale 2018)}
